    ...
    <div className="min-h-screen bg-[#FDFBF7] flex flex-col selection:bg-[#FF4500] selection:text-white">
      ...
      <main className="flex-1 py-16 px-6 md:px-12 lg:px-20 max-w-[1280px] mx-auto w-full">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16 items-stretch">
          {/* Left: Origin Story */}
          <div className="bg-white border-4 border-black p-8 md:p-10 shadow-[8px_8px_0px_0px_#000000] flex flex-col justify-between">
            <div>
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {bentoArchives.map((archive, index) => (
              <div
                key={index}
                className={`bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_#000000] flex flex-col justify-between hover:grayscale-0 transition-all ${archive.colSpan}`}
              >
                <div>
