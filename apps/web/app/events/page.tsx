      ...
      <main className="flex-1 py-16 px-6 md:px-12 lg:px-20 max-w-[1280px] mx-auto w-full">
          ...
          <div className="flex bg-white border-2 border-black p-1 shadow-[4px_4px_0px_0px_#000000]">
            {(["ALL", "OPEN MIC", "SPECIAL SHOWS"] as const).map((tab) => (
              <button
                ...
                className={`px-4 md:px-6 py-2 font-['Space_Mono',monospace] text-xs md:text-sm font-bold uppercase tracking-wider cursor-pointer transition-all ${
                  activeTab === tab
        ...
        <div className="flex flex-col gap-6">
          {filteredEvents.map((event) => (
            <article
              key={event.id}
              className="bg-white border-4 border-black p-6 md:p-8 shadow-[8px_8px_0px_0px_#000000] flex flex-col lg:flex-row lg:items-center justify-between gap-8 hover:translate-x-1 hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_#000000] transition-all"
            >
              ...
              <div className="lg:w-48 flex items-center justify-start lg:justify-end">
                <a
                  ...
                  className="w-full lg:w-auto px-6 py-3.5 bg-black hover:bg-[#FF4500] text-white font-['Space_Mono',monospace] text-sm font-bold tracking-wider uppercase border-2 border-black shadow-[4px_4px_0px_0px_#000000] flex items-center justify-center gap-2 active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all"
                >
