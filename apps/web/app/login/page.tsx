  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center p-6 md:p-12 selection:bg-[#FF4500] selection:text-white relative">
      ...
      <div className="absolute top-6 left-6 md:top-8 md:left-12 z-20">
        <Link
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 bg-white border-2 border-black font-['Space_Mono',monospace] text-xs font-bold uppercase tracking-wider shadow-[4px_4px_0px_0px_#000000] hover:bg-[#FFE9E3] active:translate-x-[2px] active:translate-y-[2px] active:shadow-[1px_1px_0px_0px_#000000] transition-all"
        >
      ...
      <AnimateReveal variant="zoom-in" durationMs={700} className="w-full max-w-4xl my-12">
