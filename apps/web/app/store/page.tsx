      ...
      <main className="flex-1 py-16 px-6 md:px-12 lg:px-20 max-w-[1280px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProducts.map((product) => (
            <div
              key={product.id}
              className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_#000000] flex flex-col justify-between"
            >
              {/* Product Visual Box */}
              ...
              <div className="p-6 flex flex-col justify-between flex-1 gap-6">
                ...
                <div className="flex flex-col gap-2 pt-2">
                  <button
                    ...
                    className="w-full py-3 bg-black hover:bg-[#281812] text-white font-['Space_Mono',monospace] text-sm font-bold tracking-wider uppercase border-2 border-black shadow-[4px_4px_0px_0px_#000000] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all cursor-pointer flex items-center justify-center gap-2"
                  >
