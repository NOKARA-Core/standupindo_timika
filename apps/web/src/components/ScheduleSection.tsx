      ...
      <div className="max-w-[1280px] mx-auto flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6">
          {scheduleList.map((item, index) => (
            <div
              key={index}
              className="w-full bg-white border-2 border-black p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-[6px_6px_0px_0px_#000000] hover:translate-x-1 hover:translate-y-1 hover:shadow-[3px_3px_0px_0px_#000000] transition-all"
            >
              {/* Date */}
              ...
              <div>
                <button
                  type="button"
                  className="px-6 py-2 bg-black hover:bg-[#281812] text-white font-['Space_Mono',monospace] text-sm font-bold tracking-wider uppercase border-2 border-black shadow-[4px_4px_0px_0px_#000000] active:translate-x-1 active:translate-y-1 active:shadow-none transition-all cursor-pointer"
                >
                  RSVP
                </button>
              </div>
